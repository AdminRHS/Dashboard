(function (global) {
    ...
    function renderStats() {
            ...
            const clampCardDisplay = (value) => Math.min(value, 3);
            const greenCardDisplay = clampCardDisplay(totalGreenCards);
            const yellowCardDisplay = clampCardDisplay(totalCards);
            const orangeCardDisplay = clampCardDisplay(cardCounts[2]);
            const redCardDisplay = clampCardDisplay(cardCounts[3]);
