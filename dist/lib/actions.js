(function registerActions(global) {
    ...
    async function removeEmployee(btn) {
        const dropdown = document.querySelector('#removeEmpDropdown .custom-dropdown-toggle');
    ...
    function submitYellowCard(btn) {
        const employeeToggle = document.querySelector('#cardEmployeeDropdown .custom-dropdown-toggle');
        const typeToggle = document.querySelector('#cardViolationTypeDropdown .custom-dropdown-toggle');
        ...
        if (!name || !type) {
            alert('Please select an employee and a violation type.');
            return;
        }
        if (!comment) {
    ...
    function submitGreenCard(btn) {
        const employeeToggle = document.querySelector('#greenCardEmployeeDropdown .custom-dropdown-toggle');
        const typeToggle = document.querySelector('#greenCardTypeDropdown .custom-dropdown-toggle');
        const name = employeeToggle?.dataset.value;
        const type = typeToggle?.dataset.value;
        const comment = document.getElementById('greenCardComment').value.trim();
        if (!name || !type) {
            alert('Please select an employee and a card type.');
            return;
        }
        if (!comment) {
            alert('Please fill in the details field.');
    ...
    async function confirmDeleteViolation(violationId, employeeName, meta) {
        if (!confirm('Remove this yellow card?'))
            return;
        let payload;
    ...
    async function confirmDeleteGreenCard(greenCardId, employeeName, meta) {
        if (!confirm('Remove this green card?'))
            return;
        let payload;
    ...
    document.addEventListener('click', (event) => {
        ...
        const btn = target.closest('.js-delete-violation');
        if (btn) {
        ...
        const greenCardBtn = target.closest('.js-delete-green-card');
        if (greenCardBtn) {
